...
public class SerialThreadBinaryDelimited : AbstractSerialThread
{
    ...
    public SerialThreadBinaryDelimited(string portName, int baudRate, int delayBeforeReconnecting, int maxUnreadMessages, byte separator) : base(portName, baudRate, delayBeforeReconnecting, maxUnreadMessages, false) => this.separator = separator;
    ...
    protected override object ReadFromWire(SerialPort serialPort)
    {
        ...
        int index = System.Array.FindIndex(buffer, 0, bufferUsed, IsSeparator);
    ...
    private bool IsSeparator(byte aByte) => aByte == separator;
}
